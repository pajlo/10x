<script setup>
  ...
  const currentFlashcard = computed(() => flashcards.value[currentCardIndex.value] || null);
  ...
  <div class="flashcards-container max-w-3xl mx-auto">
    ...
    >
      ...
      <router-link to="/my-flashcards">
        <BaseButton> Dodaj fiszki, aby rozpocząć naukę </BaseButton>
      </router-link>
    </div>
    ...
    <div v-else>
      ...
      <div class="card-container">
        <div class="flipcard cursor-pointer" @click="toggleAnswer">
      ...
      <div class="flex justify-between">
        <BaseButton variant="secondary" :disabled="currentCardIndex === 0" @click="previousCard">
          Poprzednia
        </BaseButton>

        <BaseButton :disabled="currentCardIndex === flashcards.length - 1" @click="nextCard">
          Następna
        </BaseButton>
      </div>
    </div>
